" jeremy - a vim colorscheme modified from parchment
" Maintainer: Jeremy Cowgar <jeremy@cowgar.com>
" Original Author: Alex Griffin <a@ajgrf.com>
" Version:    0.5.0-pre
...
let s:dim_pale_yellow =  [16, '#f7f7e2']
let s:dim_brown =        [17, '#b68361']
...
call s:Style('Constant',       s:green,       [],             '')
call s:Style('Identifier',     [],            [],             '')
call s:Style('Ignore',         [],            [],             '')
call s:Style('Type',           [],            [],             '')
call s:Style('Statement',      s:magenta,     [],             '')
call s:Style('Comment',        s:dim_brown,   [],             'italic')
...
call s:Style('Delimiter',      s:magenta,     [],             '')
...
call s:Style('goCoverageCovered', s:green,    s:pale_green,   '')
call s:Style('goCoverageUncover', s:red,      s:pale_red,     '')
...
call s:Style('LineNr',         [],            s:pale_blue,    '')
call s:Style('CursorLineNr',   s:black,       s:pale_green,   '')
...
call s:Style('Search',         [],            s:pale_red,     'bold')
call s:Style('IncSearch',      [],            s:pale_red,     'bold')
