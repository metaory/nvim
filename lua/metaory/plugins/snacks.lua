  ...
  opts = {
    ...
    dashboard = {
      sections = {
        ...
        {
          section = "terminal",
          cmd = "figlet -f colossal -t metaory",
          -- larry3d univers doom doh crawford clb8x8 3-d ogre roman slant banner3 basic colossal nancyj nancyj-underlined nvscript rozzo smisome1
          row = nil,
          align = "center",
          height = 11,
          padding = 1,
