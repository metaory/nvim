...
function M.add_async()
  ...
  local function_node = require("metaory.utils.treesitter").find_node_ancestor(
...
function M.goto_exported_symbol()
  ...
  local language_tree = require("metaory.utils.treesitter").get_language_tree_for_cursor_location()
